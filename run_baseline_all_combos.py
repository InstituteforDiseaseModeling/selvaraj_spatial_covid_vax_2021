...
if __name__ == "__main__":
    ...
    exp_name = 'covax_baseline_all_combos_20countries_migration_only'
    # countries = ['Ghana']
    ...
    # countries = ['Angola', 'Burkina Faso', 'Cameroon',
    #              'Chad', 'DRC', 'Ethiopia', 'Ghana', 'Ivory Coast',  'Kenya', 'Madagascar', 'Malawi', 'Mali',
    ...
    # repro_number = [2.0, 2.4, 2.8]
    repro_number = [2.0, 2.4, 2.8]
    covax_distribution = [1]
    # urban_prioritization = [0, 1, 2]          # 0 - no prioritization in time, 1 - urban priority, 2 - rural priority
    urban_prioritization = [0]  # 0 - no prioritization in time, 1 - urban priority, 2 - rural priority
    migration_rates = [1e-4, 2.5e-3, 2.5e-2]
