...
if __name__ == "__main__":
    ...
    exp_name = 'covax_age_priority_comparison'
    ...
    repro_number = [2.4]
    coverage_1stdose = [0.2, 0.35, 0.5, 0.65, 0.8]
    # coverage_1stdose = [0.2, 0.5, 0.8]
    ...
    urban_prioritization = [0]  # 0 - no spatial prioritization in time, 1 - urban priority, 2 - rural priority
    migration_rates = [2.5e-3]
    start_day = [30, 60, 90, 120, 150, 180]
    # start_day = [30, 90, 180]
    target_groups = [[15], [15, 50, 60, 70], [70, 60, 50, 15]]
    # target_groups = [[15]]
    ...
    acq_blocking_scenario = [
        ...
        for cd in covax_distribution
        for up in urban_prioritization
        for tg in ['random', 'old_first', 'young_first']
        # for tg in ['random']
